...
import { saveProductExperimentPromptTemplatesAction } from '@/app/settings/logbook-ai-packs/actions';
import type { ProductExperimentPromptTemplate } from '@/lib/logbook/productExperimentPromptTemplatesModel';

type ProductExperimentPromptTemplateEditorProps = {
  initialTemplates: ProductExperimentPromptTemplate[];
};
...
export default function ProductExperimentPromptTemplateEditor({
  initialTemplates,
}: ProductExperimentPromptTemplateEditorProps) {
  const [templates, setTemplates] = useState<ProductExperimentPromptTemplate[]>(
  ...
  const saveTemplates = () => {
    ...
    startTransition(async () => {
      try {
        ...
        await saveProductExperimentPromptTemplatesAction(sanitized);
            ...
            <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2 text-sm text-muted">
                  <input
                    type="radio"
                    name="product-experiment-prompt-default"
