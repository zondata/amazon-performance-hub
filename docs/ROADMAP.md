...
Note (2026-03-01): Product experiment prompt templates now enforce Output Contract V1 metadata instructions for `formatting_only` and `experiment_partner` by default and via settings normalization fallback.
